...
At each horizon $t$, `rtichoke` truncates follow-up at $t$. Events before $t$ remain events, follow-up beyond $t$ is censored at $t$, and earlier censoring times remain unchanged. Within each prediction group, `rtichoke` estimates
