...
Only the five-year curve assesses calibration because the predictions remain five-year risks. Years one through four are diagnostic. Discrete observed risks should not fall as the horizon advances. If they do, check the event times, indicators, and censoring logic. Unexpectedly early agreement with the diagonal warrants checking for target leakage. Smoothed curves may cross locally.

At each horizon $t$, `rtichoke` counts events observed by $t$ and retains earlier censoring times. Within each prediction group, it estimates
