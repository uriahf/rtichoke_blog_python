...
For smooth calibration, `rtichoke` transforms predicted risk as

$$
x_i = \log\{-\log(1-\hat p_i)\},
$$

then fits a secondary Cox model with a **3-knot restricted cubic spline of $x_i$** as its sole predictor. Predictions at horizon $t$ form the smooth calibration curve.
