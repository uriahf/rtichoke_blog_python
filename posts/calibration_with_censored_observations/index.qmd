...
This example uses the Rotterdam and GBSG data from McLernon and colleagues' [guidance on evaluating prediction-model performance metrics for time-to-event outcomes](https://doi.org/10.7326/M22-0844) and [companion repository](https://github.com/danielegiardiello/Prediction_performance_survival). The endpoint is recurrence or death.
