...
At each horizon $t$, `rtichoke` truncates follow-up at $t$. Events before $t$ remain events, follow-up beyond $t$ is censored at $t$, and earlier censoring times remain unchanged. For discrete calibration, patients are ordered by predicted risk and divided into ten similarly sized groups. In each group, `rtichoke` estimates
